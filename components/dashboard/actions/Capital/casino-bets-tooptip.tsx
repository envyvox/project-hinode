...
const CasinoBetsTooltip = () => {
  ...
  const formattedStrings = {
    caseLose: formatString(
      dictionary.dashboard["actions.capital.casino.bet.tooltip.case-lose"],
      <Icons.Ien />
    ),
    caseX2: formatString(
      dictionary.dashboard["actions.capital.casino.bet.tooltip.case-x2"],
      <Icons.Ien />
    ),
    caseX4: formatString(
      dictionary.dashboard["actions.capital.casino.bet.tooltip.case-x4"],
      <Icons.Ien />
    ),
    caseX10: formatString(
      dictionary.dashboard["actions.capital.casino.bet.tooltip.case-x10"],
      <Icons.Ien />
    ),
  };
